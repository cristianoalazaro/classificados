...
class Anuncios{
    public function getTotalAnuncios($filtros){
        ...
        $sql = $pdo->prepare("SELECT COUNT(*) as total FROM anuncios WHERE 
    ...
    public function getAnuncio($id){
        $array = [];
        global $pdo;
        $sql = $pdo->prepare("SELECT *, (select categorias.nome from categorias where 
    ...
    public function addAnuncio($titulo, $categoria, $valor, $descricao, $estado){
        global $pdo;
        $sql = $pdo->prepare("INSERT INTO anuncios (titulo, id_categoria, preco, descricao, 
    ...
    public function editAnuncio($titulo, $categoria, $valor, $descricao, $estado, $fotos, $id){
        global $pdo;
        $sql = $pdo->prepare("UPDATE anuncios SET titulo = :titulo, id_categoria = :categoria, 
